...
class Config:
    ...
    # Maximum content length: 50MB to allow up to 3 files of 16MB each with overhead
    MAX_CONTENT_LENGTH = int(os.environ.get('MAX_CONTENT_LENGTH', 50 * 1024 * 1024))  # 50MB in bytes
